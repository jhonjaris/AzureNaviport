...
# -*- coding: utf-8 -*-
"""
Generador de PDF con imágenes para el Manual de Pantallas NaviPort RD
"""
...
def crear_pdf_manual_con_imagenes():
    """Genera el PDF del manual de pantallas con imágenes"""
    ...
    # Agregar cada pantalla con su imagen
    for pantalla in pantallas:
        ...
        if os.path.exists(pantalla["imagen"]):
            try:
                img = Image(pantalla["imagen"], width=5*inch, height=3.5*inch)
                story.append(img)
                story.append(Spacer(1, 10))
            except:
    ...
    # Construir el PDF
    doc.build(story)
    print("PDF con imágenes generado exitosamente: docs/PANTALLAS_SISTEMA_NAVIPORT.pdf")

if __name__ == "__main__":
    crear_pdf_manual_con_imagenes()